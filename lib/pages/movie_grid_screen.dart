...
import 'package:flutterinternal/pages/new_popular_page.dart';
import 'package:flutterinternal/pages/new_top_rated_page.dart';
...
class _MovieGridscreenState extends State<MovieGridscreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('IMDB APP'),
        backgroundColor: Color(0xFFEE3E3E), // AppBar color
      ),
      body: Padding(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: Color(0xFF1633C7), // Text color
                    ),
                  ),
                  GestureDetector(
                    onTap: () {
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 18,
                        color: Color(0xFFEE16A8), // Text color
                      ),
                    ),
                  ),
                ],
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Card(
                          color: Color(0xFF940AE5).withOpacity(0.1), // Card background color
                          child: Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF55047C), // Text color
                                ),
                              ),
                              Text(
                                movies[index].year,
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Card(
                          color: Color(0xFFE1CF0B).withOpacity(0.1), // Card background color
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF5B5703), // Text color
                                ),
                              ),
                              Text(
                                topMovies[index].year,
                                style: TextStyle(color: Colors.black54), // Text color
                              ),
                            ],
                          ),
